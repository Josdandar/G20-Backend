//Siempre que usemos async await utilizar try y catch
...
const cake = {
  ...
  makeACake()
  .then((decorateTheCake) => {
    console.log("Cake from then", decorateTheCake)
  })
  .catch((err)=>{
    console.log("Something happen")
  })//this returns the value of a async/promise function 
